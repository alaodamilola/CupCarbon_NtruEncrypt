...
//		}
		...
		// added Blowfish encryption Function call -Damilola Alao
				if(function.equals("encrypt")) {
					try {
						return new String [] {Functions.encrypt(args), "0.027743", "0.000000000000000019092"};						
					} catch (Exception e) {
				...
				// added NtruEncrypt Function Call - Damilola Alao
				if(function.equals("thencrypt")) {
					try {
						return new String [] {Functions.thencrypt(args), "0.0", "0.0"};
					} catch (Exception e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
					}
